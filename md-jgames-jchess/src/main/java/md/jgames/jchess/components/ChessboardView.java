...
public final class ChessboardView extends JComponent implements MouseListener, MouseMotionListener, ChessboardListener {
	...
	public void putImageForPiece(byte p, Image i) {
		if (i == null)
	...
	public Image getImageForPiece(byte piece) {
		return chessmenImagesMap.get(piece);
	}

	public void putChessboardImage(Image i) {
	...
	public void unmarkSquare(String sq) {
		markedSquares.remove(sq);
	}

	public Color getMarkForSquare(String sq) {
	...
	public void reset() {
		for (char ch : new char[] { 'k', 'q', 'r', 'n', 'b', 'p' }) {
			this.putImageForPiece(Utilities.pieceCharToConstant(ch),
					Resources.loadImageResource("default-piece-b" + ch + ".png"));
			this.putImageForPiece(Utilities.pieceCharToConstant(Character.toUpperCase(ch)),
					Resources.loadImageResource("default-piece-w" + ch + ".png"));
		}
		this.putChessboardImage(Resources.loadImageResource("default-chessboard.png"));
	}
