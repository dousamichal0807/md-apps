 ...
 * @author Michal Douša
 */
public final class AdvancedAWTGraphics {
	 ...
	 * {@code AdvancedAWTGraphics} object is using.
	 * 
	...
	/**
	 * Constructs an {@code AdvancedAWTGraphics} object using given
	 ...
	 * @see #getBaseGraphics()
	 */
	public AdvancedAWTGraphics(final Graphics2D graphics) {
		if (graphics == null)
