...
public final class ProgressBarTest extends Application {
    ...
    public void start(final Stage primaryStage) {
        MDFXProgressBar progressBar = new MDFXProgressBar(MDFXProgressBar.INDETERMINATE, new TimesTablesPBAnimationTimer());
        ...
        valueSlider.valueProperty().addListener(observable -> {
            ...
            if (newValue == MDFXProgressBar.INDETERMINATE || (newValue >= 0 && newValue <= 1))
