...
public final class TimesTablesPBAnimationTimer implements MDProgressBar.Animator {
    ...
    public TimesTablesPBAnimationTimer(final int lineCount, final int multiplier) {
    ...
    public void setLineCount(final int lineCount) {
        this.lineCount = Math.max(lineCount, 20);
    }
    ...
    @Override
    public strictfp void refresh(final long nanoTime, final MDProgressBar progressBar) {
        ...
        double shownLinesCount = lineCount * progress;
